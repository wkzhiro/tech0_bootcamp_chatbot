          ...
          <div className="">
            ...
            <div className="chat-container">
              <div className="w-full h-full flex flex-col bg-white chat-main">
                ...
                >
                  <div className="text-center">
                    <h1 className="text-3xl font-semibold text-gray-900 mt-8">{process.env.NEXT_PUBLIC_MAINTENANCE_TITLE}</h1>
                    <p className="text-normal text-gray-600 mt-5">{process.env.NEXT_PUBLIC_MAINTENANCE_BODY}</p>
                  </div>
                </div>
              </div>
            </div>
